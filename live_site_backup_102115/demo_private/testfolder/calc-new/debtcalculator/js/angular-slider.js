  ...
  sliderDirective = function($timeout) {
    return {
      ...
      compile: function(element, attributes) {
        var ceilBub, cmbBub, e, flrBub, fullBar, highBub, lowBub, maxPtr, minPtr, refMark1, refMark2, mark1Ptr,mark2Ptr, range, refHigh, refLow, selBar, selBub, watchables, _i, _len, _ref, _ref1;
        ...
        watchables = [refLow, 'floor', 'ceiling'];//,refMark1,refMark2];
        if (range) {
