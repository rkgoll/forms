...
(function() {
  ...
  sliderDirective = function($timeout) {
    return {
      ...
      template: '<span class="bar"></span><span class="bar selection"></span><span class="mark1"></span><span class="mark2"></span><span class="pointer"></span><span class="pointer"></span><span class="bubble selection"></span><span ng-bind-html-unsafe="translate({value: floor})" class="bubble limit"></span><span ng-bind-html-unsafe="translate({value: ceiling})" class="bubble limit"></span><span class="bubble"></span><span class="bubble"></span><span class="bubble"></span>',
      compile: function(element, attributes) {
        var ceilBub, cmbBub, e, flrBub, fullBar, highBub, lowBub, maxPtr, minPtr, refMark1, refMark2, refMax, mark1Ptr,mark2Ptr, range, refHigh, refLow, selBar, selBub, watchables, _i, _len, _ref, _ref1;
        ...
        _ref = (function() {
          ...
          return _results;
        })(), fullBar = _ref[0], selBar = _ref[1], mark1Ptr=_ref[2], mark2Ptr=_ref[3], minPtr = _ref[4], maxPtr = _ref[5], selBub = _ref[6], flrBub = _ref[7], ceilBub = _ref[8], lowBub = _ref[9], highBub = _ref[10], cmbBub = _ref[11];
        refLow = range ? 'ngModelLow' : 'ngModel';
        refHigh = 'ngModelHigh';
        refMark1 ='ngModelMark1';
        refMark2 ='ngModelMark2';
        refMax = 'ceiling';
        refMin = 'ceiling';
        ...
        watchables = [refLow, 'floor', refMax];//,refMark1,refMark2];
        if (range) {
          watchables.push(refHigh);
        }
        return {
          post: function(scope, element, attributes) {
            var barWidth, boundToInputs, dimensions, maxOffset, maxValue, minOffset, minValue, ngDocument, offsetRange, pointerHalfWidth, updateDOM, valueRange, mark1,mark2, w, _j, _len1;
            ...
            dimensions = function() {
              var value, _j, _len1, _ref2, _ref3, _ref4, _ref5;
              ...
              maxValue = parseFloat(scope[refMax]);

              mark1 = roundStep(parseFloat(scope[refMark1]), parseInt(scope.precision), parseFloat(scope.step), parseFloat(scope.floor));
              mark2 = roundStep(parseFloat(scope[refMark2]), parseInt(scope.precision), parseFloat(scope.step), parseFloat(scope.floor));
            ...
            updateDOM = function() {
              ...
              setPointers = function() {
                ...
                offset(mark1Ptr, percentToOffset(percentValue(mark1)));
                offset(mark2Ptr,percentToOffset(percentValue(mark2)))
