...
<head>
	...
	<link rel="icon" href="demo_private/testfolder/calc-new/website/img/lendlift_fav_ico.png">
	<link rel="shortcut icon" href="demo_private/testfolder/calc-new/website/img/lendlift_fav_ico.png"/>
  ...
  <script type="text/javascript">stLight.options(
        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav" id="navTab">
			  ...
			  <li><a href="http://lendlift.com/demo_private/testfolder/index.html" class="bg-primary">GO LENDLIFT</a></li>
    ...
    <script src="/calc-new/website/js/bootstrap-tab.js"></script>
	<script src="/calc-new/website/js/bootstrap-modal.js"></script>
	<script src="/calc-new/website/js/bootstrap-transition.js"></script>
	<script src="/calc-new/website/js/bootstrap-scrollspy.js"></script>
	<script src="/calc-new/website/js/bootstrap-carousel.js"></script>

	<script src="/calc-new/website/js/d3.v3.min.js" charset="utf-8"></script>
    <script src="/calc-new/website/js/angular.min.js"></script><!--1.1.4-->
	
	<script src="/calc-new/website/js/angulartics.min.js"></script>
	<script src="/calc-new/website/js/angulartics-google-analytics.min.js"></script>
    <script src="/calc-new/website/js/angular-slider.js"></script>
    <script src="/calc-new/website/js/mainlib.js"></script>

    <script src="/calc-new/website/js/html2canvas.js"></script>
    <script src="/calc-new/website/js/ui-bootstrap-tpls-0.6.0.js"></script>
    <script src="/calc-new/website/js/angular-cookies-1.0.0rc10.js"></script>
